...
public class SchoolTeamList extends RecyclerView.Adapter<SchoolTeamList.MyViewHolder> {

    private List<VolunteerModel> list;
    private Activity activity;

    public SchoolTeamList(List<VolunteerModel> list, Activity activity) {
        this.list = list;
    ...
    @Override public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.gender.setText(list.get(position).getTeamname());
